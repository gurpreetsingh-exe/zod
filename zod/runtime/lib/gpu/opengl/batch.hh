...
public:
  ...
  auto draw_instanced(SharedPtr<GPUShader>, usize /* instance_count */)
      -> void override;
  auto draw_indirect(SharedPtr<GPUShader>) -> void override;
  auto upload_indirect(const void*, usize) -> void override;
  auto draw_lines(SharedPtr<GPUShader>) -> void override;
