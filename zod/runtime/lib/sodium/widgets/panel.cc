...
//     : widget(std::move(name)), m_camera(camera), m_padding(padding),
...
//           m_camera->get_view_projection(), vec4(m_camera->get_direction(),
//           0.0f)
//         };
//         m_uniform_buffer->write(&storage,
//         sizeof(CameraUniformBufferStorage));
//       }
//     } break;
//     default:
...
//   auto size =
//       vec2(ImGui::GetContentRegionAvail().x,
