...
//   ImGui::Separator();
//
//   draw_component<TransformComponent>("Transform", entity, [&](auto&
//   component) {
//     auto needs_update =
//         DragFloat3("Location", (float*)&component.position, 0.1f);
//     needs_update |= DragFloat3("Rotation",
//     (float*)&component.rotation, 1.0f); needs_update |= DragFloat3("Scale",
//     (float*)&component.scale, 0.1f); return needs_update;
//   });
//
